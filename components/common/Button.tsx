...
const Button: React.FC<ButtonProps> = ({ children, variant = 'primary', isLoading = false, className = '', ...props }) => {
  ...
  const variantClasses = {
    primary: 'text-white bg-brand hover:bg-brand/90 focus:ring-brand',
    secondary: 'text-dark bg-accent hover:bg-accent/90 focus:ring-accent',
    danger: 'text-white bg-danger hover:bg-danger/90 focus:ring-danger',
  };
